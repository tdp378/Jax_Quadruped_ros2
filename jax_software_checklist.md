...
| Phase 1 — Robot Description (URDF/Xacro)   | Visual meshes load         | meshes/*          | STL/DAE visible in RViz     | Complete |        |
| Phase 1 — Robot Description (URDF/Xacro)   | Collision geometry defined | URDF              | Simplified shapes           | Complete |        |
| Phase 1 — Robot Description (URDF/Xacro)   | Inertial blocks defined    | URDF              | Mass + inertia per link     | Complete |        |
| Phase 1 — Robot Description (URDF/Xacro)   | Leg macro created          | leg.urdf.xacro    | Parametric leg definition   | Complete |        |
| Phase 1 — Robot Description (URDF/Xacro)   | 4 legs instantiated        | jax.urdf.xacro    | fl / fr / rl / rr           | Complete |        |
...
| Phase 2 — State Publishing & Visualization | Display launch file        | display.launch.py | One-command bringup         | Complete |        |
